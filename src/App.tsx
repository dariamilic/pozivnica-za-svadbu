          ...
          <div className="flex flex-row justify-center items-center gap-8 md:gap-16">
            <div className="flex flex-row items-center gap-8 md:gap-16">
              <div className="flex flex-col items-center">
                ...
                <a href="tel:0955099162" className="text-olive-dark/60 hover:text-olive-dark transition-colors text-xs md:text-sm tracking-[0.2em]" style={{ whiteSpace: 'nowrap' }}>
                  095 509 9162
                </a>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <a href="tel:0992730826" className="text-olive-dark/60 hover:text-olive-dark transition-colors text-xs md:text-sm tracking-[0.2em]" style={{ whiteSpace: 'nowrap' }}>
                  099 273 0826
                </a>
              </div>
            </div>
